...
%% Paper title.
\title{Interactive Exploration of Protein-Protein Interactions}
...
\maketitle
\textcolor{red}{TODO -- add definitions of conformation, contact zone, ...}
...
We present three novel methods for the visualization and comparison of individual conformations.
...
The issue of visual representation can be tackled from different perspectives.
...
\textcolor{red}{MoleCollar, EuroVis STAR, lens view - Marc Streit (StratomX), EuroVis STAR on lenses}
