...
In this section we will mention the existing visual representations of protein-protein interactions.
Many existing solutions focus on the visualization of whole networks of interacting proteins.
Web-based visualizations = Jeanquartier et al.~\cite{Jeanquartier2015}.
Surfaces on contact zones = Jin et al.~\cite{Jin2014}.
