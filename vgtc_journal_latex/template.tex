...
The user can further explore the constitution of the contact zones in detail by using the open-book view where the individual amino acids can be highlighted using different visualization method. \textcolor{red}{image?}
...
It is clearly visible that \textcolor{red}{TODO}
...
Idea -- to take one representative of each cluster (because in clusters the conformations are similar) and try to find the best solutions. But to find the best ones, I'll need Honza Palecek (hope to meet him on Tuesday).
